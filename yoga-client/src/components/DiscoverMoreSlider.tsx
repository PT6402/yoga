...
import img1 from "../assets/img/collections/1.png";
import img2 from "../assets/img/collections/5.png";
import img3 from "../assets/img/collections/4.png";
import img4 from "../assets/img/collections/3.png";
...
export default function DiscoverMoreSlider() {
  const id = useId();
